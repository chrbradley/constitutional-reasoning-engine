"""
Test Llama 3 8B with one complete experiment run
"""
import asyncio
import json
import sys
...
async def test_llama_pipeline():
    """Run one complete test with Llama to check JSON parsing and max_tokens"""
    ...
    # Layer 2: Constitutional Reasoning (with Llama)
    print("\nLayer 2: Constitutional Reasoning (Llama)...")
    ...
    constitutional_response = await get_model_response(
        ...
        temperature=0.7,
        max_tokens=6000  # Test with higher limit for Llama
    )
