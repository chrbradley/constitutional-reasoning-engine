"""
Test DeepSeek Chat with one complete experiment run
"""
import asyncio
import json
import sys
...
async def test_deepseek_pipeline():
    """Run one complete test with DeepSeek to check JSON parsing and max_tokens"""
    ...
    # Layer 2: Constitutional Reasoning (with DeepSeek)
    print("\nLayer 2: Constitutional Reasoning (DeepSeek)...")
    ...
    constitutional_response = await get_model_response(
        ...
        temperature=0.7,
        max_tokens=8000  # Start with baseline
    )
