"""
Test Grok 3 with one complete experiment run
"""
import asyncio
import json
import sys
...
async def test_grok_pipeline():
    """Run one complete test with Grok to check JSON parsing and max_tokens"""
    ...
    # Layer 2: Constitutional Reasoning (with Grok)
    print("\nLayer 2: Constitutional Reasoning (Grok 3)...")
