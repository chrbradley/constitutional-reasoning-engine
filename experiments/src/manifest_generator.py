...
from experiment_state import ExperimentManager, TestStatus
...
def save_manifest(experiment_manager: ExperimentManager, output_path: Path = None) -> Path:
    ...
    if output_path is None:
        # Save to experiment's run directory
        exp_id = experiment_manager.experiment_id
        if exp_id:
            output_path = experiment_manager.base_dir / "runs" / exp_id / "MANIFEST.txt"
        else:
