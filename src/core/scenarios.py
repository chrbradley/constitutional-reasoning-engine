...
from src.core.data_types import Scenario


def load_scenarios(scenarios_file: str = "src/data/scenarios.json") -> List[Scenario]:
    """
...
def get_scenario_by_id(scenario_id: str, scenarios_file: str = "src/data/scenarios.json") -> Scenario:
    """
...
def list_scenario_ids(scenarios_file: str = "src/data/scenarios.json") -> List[str]:
    """
...
def list_scenarios_by_category(category: str, scenarios_file: str = "src/data/scenarios.json") -> List[Scenario]:
    """
